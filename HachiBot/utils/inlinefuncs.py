...
from HachiBot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from HachiBot.services.tasks import _get_tasks_text, all_tasks, rm_task
from HachiBot.services.types import InlineQueryResultCachedDocument
from HachiBot.modules.info import get_chat_info, get_user_info
from HachiBot.modules.music import download_youtube_audio
from HachiBot.utils.functions import test_speedtest
...
async def alive_function(answers):
    ...
    msg = f"""
**[ᴘʀɪᴍᴇ ᴍᴇɢᴀ](https://t.me/HachiBotBot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
