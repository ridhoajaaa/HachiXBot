...
from HachiBot import telethn, MONGO_DB_URI, BOT_ID
...
__help__ = """
• Hachi can protect your group from NSFW senders, Slag word users and also can force members to use English
*Commmands:*
