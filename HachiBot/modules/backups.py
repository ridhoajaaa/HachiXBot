...
import HachiBot.modules.sql.notes_sql as sql
from HachiBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from HachiBot.__main__ import DATA_IMPORT
...
# from HachiBot.modules.rules import get_rules
import HachiBot.modules.sql.rules_sql as rulessql

# from HachiBot.modules.sql import warns_sql as warnssql
import HachiBot.modules.sql.blacklist_sql as blacklistsql
from HachiBot.modules.sql import disable_sql as disabledsql

# from HachiBot.modules.sql import cust_filters_sql as filtersql
# import HachiBot.modules.sql.welcome_sql as welcsql
import HachiBot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Hachi Mega{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Hachi Mega{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Hachi Mega-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Hachi Mega{}.backup".format(chat_id))  # Cleaning file
