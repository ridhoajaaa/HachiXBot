from HachiBot.modules.disable import (
...
from HachiBot import dispatcher as d, LOGGER
...
ddocmd = ddoHandler(d).command
ddomsg = ddoHandler(d).message
ddocallback = ddoHandler(d).callbackquery
ddoinline = ddoHandler(d).inlinequery
