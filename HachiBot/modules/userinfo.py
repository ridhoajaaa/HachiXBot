...
from HachiBot.modules.sql.global_bans_sql import is_user_gbanned
from HachiBot.modules.sql.afk_sql import is_afk, set_afk
from HachiBot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Disaster level of this person is 'Lord Di Atas Lord'."
        ...
        disaster_level_present = True
    elif user.id == 2116358006:
         text += "\n\nOwner Of A Bot. Queen Of @ddodxy. Bot Name Inspired From 'kntl'."
         disaster_level_present = True
...
def stats(update: Update, context: CallbackContext):
    stats = "❂ <b>Stats For <a href='https://t.me/HachiXBot'> HachiXBot</a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
