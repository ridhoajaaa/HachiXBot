...
from HachiBot.__main__ import STATS, TOKEN, USER_INFO
from HachiBot.modules.helper_funcs.chat_status import sudo_plus
from HachiBot.modules.helper_funcs.decorators import ddocallback, ddocmd
from HachiBot.modules.helper_funcs.extraction import extract_user
from HachiBot.modules.no_sql.global_bans_db import is_user_gbanned
from HachiBot.modules.no_sql.users_db import get_user_num_chats
from HachiBot.modules.redis.afk_redis import afk_reason, is_user_afk
...
@ddocmd(command="stats", can_disable=True)
@sudo_plus
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + "\n\n⍙ [GitHub](https://github.com/ridhoajaaa/HachiXBot) | ⍚ [GitLab](https://gitlab.com/aryazakaria01/HachiBot-Nagisa)\n\n"
                )
                + "╘══「 by [ddox](github.com/ridhoajaaa) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(kb),
            disable_web_page_preview=True,
