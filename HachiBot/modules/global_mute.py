...
import HachiBot.modules.sql.global_mutes_sql as sql
from HachiBot import dispatcher, OWNER_ID, DEV_USERS, DRAGONS, DEMONS, TIGERS, STRICT_GMUTE
from HachiBot.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
GMUTE_ENFORCER = MessageHandler(Filters.all & filters=Filters.chat_type.groups, enforce_gmute)
