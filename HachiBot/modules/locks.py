...
import HachiBot.modules.sql.locks_sql as sql
...
from HachiBot.modules.helper_funcs.chat_status import can_delete, is_bot_admin
...
from HachiBot.modules.redis.approvals_redis import is_approved
...
@ddocmd(command="lock", pass_args=True)
...
@ddocmd(command="unlock", pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@ddomsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
