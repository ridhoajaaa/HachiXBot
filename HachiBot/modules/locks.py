...
from HachiBot import dispatcher, DRAGONS, LOGGER
...
LOCK_HANDLER = CommandHandler("lock", lock, run_async=True, pass_args=True)  # , filters=Filters.chat_type.groups)
UNLOCK_HANDLER = CommandHandler(
    "unlock", unlock, run_async=True, pass_args=True
