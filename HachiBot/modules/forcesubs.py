...
from HachiBot.modules.sql import forceSubscribe_sql as sql
...
__help__ = """
*Force Subscribe:*
❂ Hachi can mute members who are not subscribed your channel until they subscribe
